                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-lg-2 col-md-3 text-md-left text-center">
                                <img src="@if(Auth::user()->avatar) {{Auth::user()->avatar}} @else {{asset('/assets/images/users/avatar-7.jpg')}} @endif" class="avatar avatar-large rounded-circle shadow d-block mx-auto" alt="">
                            </div><!--end col-->
